...
/// Pipeline manager for render and compute pipelines
...
impl PipelineManager {
    pub fn new(
        ...
        let (particle_bind_group, compute_pipeline, particle_render_pipeline) =
            Self::create_particle_system(device, fft_buffer, uniform_buffer, particle_buffer, render_pipeline_layout, format)?;
