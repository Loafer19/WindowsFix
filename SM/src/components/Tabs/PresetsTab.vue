<template>
    <div class="mb-6">
        <p class="text-base-content/70">
            One-click presets to quickly configure your system. Each preset shows exactly which services
            will be changed and why before you apply it.
        </p>
    </div>
        ...
        <div v-for="preset in presets" :key="preset.id"
            ...
            <div class="card-body">
                ...
                <div class="card-actions">
                    <Button
                        :class="`btn btn-${preset.color} btn-sm w-full`"
                        @clicked="$emit('apply-preset', preset)">
